const CACHE="entego-v14";
const ASSETS=["/","/manifest.webmanifest?v=14","/icon-192.png?v=14","/icon-512.png?v=14","/icon-maskable-512.png?v=14","/apple-touch-icon.png?v=14","/logo-header.png?v=14"];
